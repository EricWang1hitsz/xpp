...
LaikagolegInverseKinematics::GetJointAngles (const Vector3d& ee_pos_H, KneeBend bend) const
{
...
void
LaikagolegInverseKinematics::EnforceLimits (double& val, JointID joint) const
{
  ...
  static const std::map<JointID, double> max_range {
  ...
  // reduced joint angles for optimization
  static const std::map<JointID, double> min_range {
