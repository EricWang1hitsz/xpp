...
@Description Lge inverse kinematics of Laikago robot.
...
private:
  Vector3d hfe_to_haa_z = Vector3d(0.0, 0.0, 0.037); //distance of HFE to HAA in z direction
  double length_thigh = 0.20; // length of upper leg
