...
public:
   ...
   * at the hip-aa (H).
   */
//  Vector3d GetJointAngles(const Vector3d& ee_pos_B, KneeBend bend, int ee);
  Vector3d GetJointAngles(const Vector3d& ee_pos_B, std::string limbType, LimbEnum limb);
   ...
   */
  void EnforceLimits(double& q, JointID joint) ;
